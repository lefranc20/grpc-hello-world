...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.HelloWorldServiceProto.HelloRequest,
      grpc.HelloWorldServiceProto.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = grpc.HelloWorldServiceProto.HelloRequest.class,
      responseType = grpc.HelloWorldServiceProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.HelloWorldServiceProto.HelloRequest,
      grpc.HelloWorldServiceProto.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<grpc.HelloWorldServiceProto.HelloRequest, grpc.HelloWorldServiceProto.HelloResponse> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<grpc.HelloWorldServiceProto.HelloRequest, grpc.HelloWorldServiceProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.HelloWorldServiceProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.HelloWorldServiceProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(grpc.HelloWorldServiceProto.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc.HelloWorldServiceProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceStub
    ...
    /**
     */
    public void sayHello(grpc.HelloWorldServiceProto.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc.HelloWorldServiceProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub
    ...
    /**
     */
    public grpc.HelloWorldServiceProto.HelloResponse sayHello(grpc.HelloWorldServiceProto.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.HelloWorldServiceProto.HelloResponse> sayHello(
        grpc.HelloWorldServiceProto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((grpc.HelloWorldServiceProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<grpc.HelloWorldServiceProto.HelloResponse>) responseObserver);
          break;
        default:
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              grpc.HelloWorldServiceProto.HelloResponse>(
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.HelloWorldServiceProto.getDescriptor();
    }
